...
*/
  ...
  ------ >> 단일행 함수 << ------
    ...
    */
    ...
    --- 1.14 lengthb : 문자열의 byte 수를 알려주는 것 ---
...
/*
    ...
    */    
    ...
    -- 이전글(글번호를 내림차순 했을 때 아래의 것) // lag : 나를 기준으로 n칸 위, lead : 나를 기준으로 n칸 아래
...
--  또는
   ...
   */ 
   ...
   from tbl_authorbook A1 , tbl_authorbook A2
   WHERE A1.bookname = A2.bookname AND A1.authorname != A2.authorname
   order by A1.bookname, A1.authorname desc;        -- select 에 있는 loyalty를 써옴. ▶ 오류 
